...
1. **00 - Inbox**
    ...
    - Local para anotações rápidas e não organizadas. Use como uma "caixa de entrada" para ideias que ainda precisam ser categorizadas.
2. **01 - Notas Diárias**
    
    - Para notas diárias ou journaling. Ideal para registrar pensamentos, tarefas e eventos do dia a dia.
3. **02 - Projetos**
    
    - Organize seus projetos em subpastas. Cada projeto pode ter suas próprias notas, tarefas e recursos.
4. **03 - Áreas de Interesse**
    
    - Divida seus interesses em categorias. Por exemplo, "Filosofia" para notas sobre estudos filosóficos, "Tecnologia" para inovações, etc.
5. **04 - Recursos**
    
    - Armazene templates, referências e arquivos úteis. Mantenha tudo organizado para fácil acesso.
6. **05 - Revisão**
    
    - Pasta para notas que precisam de revisão ou atualização. Use para revisar e refinar suas ideias.
7. **06 - Configurações**
    
    - Guarde configurações, plugins personalizados ou scripts específicos do Obsidian.

### Dicas Adicionais

- Use **links internos** para conectar notas relacionadas.
- Aproveite **tags** para categorizar notas de forma transversal.
- Crie **templates** para notas recorrentes, como reuniões ou resumos de leitura.

Essa estrutura ajuda a manter seu vault organizado e facilita a navegação e a produtividade. Adapte conforme suas necessidades!
### **1. Tipos Principais de Notas**

#intro
![image.png](CURSO-ZETTELKASTEN/INBOX/Conceitos%20Básicos/zetelkastten-digital/image.png)
