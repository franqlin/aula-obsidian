---
cards-deck: CURSO-ZETTELKASTEN::NOTAS-PERMANENTES::Apresentação::POWERPOINT::INBOX::SLIDE2
---

### 1. **O que é Obsidian?**
	#card 
O **Obsidian** é uma ferramenta de anotações baseada em Markdown que permite criar, organizar e vincular notas de forma eficiente. Ele é amplamente utilizado para gerenciamento de conhecimento pessoal e profissional, oferecendo recursos como gráficos de rede (para visualizar conexões entre notas), plugins extensíveis e suporte para armazenamento local de arquivos.
^1741409732463
...
- **Ligações entre notas**: As notas são interconectadas por meio de referências cruzadas, criando uma rede de conhecimento.
- **Revisão constante**: O sistema incentiva a revisão e a recombinação de ideias para gerar novos insights.
...
#### c) **Aplicação Prática**
#card 
- **Tomada de Decisão**: Utilize o conhecimento organizado para apoiar decisões estratégicas, como monitoramento de concorrentes ou identificação de riscos.
- **Colaboração**: Compartilhe notas e insights com equipes, promovendo a colaboração e a inovação.
#card 
#### d) **Automatização e Plugins**
#card
- **Plugins do Obsidian**: Utilize plugins como "Dataview" para criar visualizações dinâmicas de dados OSINT ou "Templater" para automatizar a criação de notas.
- **Integração com Ferramentas OSINT**: Conecte o Obsidian a ferramentas de coleta de dados OSINT (por exemplo, scripts Python ou APIs) para automatizar a ingestão de informações.

---

### Exemplo de Fluxo de Trabalho Integrado
#card 
1. **Coleta de Dados**: Use ferramentas OSINT para coletar informações relevantes.
2. **Criação de Notas**: Transforme os dados em notas no Obsidian, aplicando o método Zettelkasten.
3. **Análise e Conexão**: Vincule as notas e utilize gráficos de rede para identificar insights.
4. **Aplicação**: Utilize os insights para apoiar decisões ou compartilhar conhecimento com a equipe.
